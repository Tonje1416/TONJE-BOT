...
const botname = process.env.BOTNAME || '𝐓𝐎𝐍𝐉𝐄 𝐁𝐎𝐓';
const antibot = process.env.ANTIBOT || 'FALSE';
   ...
   const quoted = (fatkuns.mtype == 'buttonsMessage') ? fatkuns[Object.keys(fatkuns)[1]] : (fatkuns.mtype == 'templateMessage') ? fatkuns.hydratedTemplate[Object.keys(fatkuns.hydratedTemplate)[1]] : (fatkuns.mtype == 'product') ? fatkuns[Object.keys(fatkuns)[0]] : m.quoted ? m.quoted : m;
    ...
    const author = process.env.STICKER_AUTHOR ||'𝐓𝐎𝐍𝐉𝐄 𝐁𝐎𝐓';
    const packname = process.env.STICKER_PACKNAME || 'Tonje';
...
let { key } = await client.sendMessage(from, {text: '𝐈 𝐚𝐦 Tonje_AI})
...
case 'restart':  
  if (!Owner) throw `Only Owner can restart me` 
  reply(`Restarting. . .`)  
  await sleep(3000)  
  process.exit()  
  break;
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𝐓𝐎𝐍𝐉𝐄 𝐁𝐎𝐓'); 
} catch (errr) { 
...
`👋🏻 Hi *${pushname}*,You can deploy 𝐓𝐎𝐍𝐉𝐄 𝐁𝐎𝐓 using the GitHub link below🗿\n\nFork and give us a star✨.\n\n https://github.com/Tonje1416/TONJE-BOT\n\nEnjoy and have fun with the bot🗿...\n\nUse the link below to pair 𝐓𝐎𝐍𝐉𝐄 𝐁𝐎𝐓 without scanning any qr code\n\n [https://replit.com/@multonny748/Pairing]\n\nType ${prefix}Tutorial and follow the steps if you dont know how to deploy the bot\n\n           Made on Earth by 𝐢𝐭'𝐬 𝐓𝐨𝐧𝐣𝐞` });
 ...
 m.reply('Group successfully locked mate😌!'); 
 } 
 break; 
 ...
 m.reply('Group successfully unlocked buddy😊!'); 
...
case 'ytsearch':
    case 'yts': {
        if (!text) {
            reply('Provide a search term!\E.g: Alan walker faded')
            return;
        }
        const term = text;
        const {
        ...
        try {
            ...
            if (fileSizeInMegabytes <= 100) {
                client.sendMessage(
                    from, {
                        video: fs.readFileSync(`./${randomName}`),
                        caption: `𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐛𝐲 𝐓𝐎𝐍𝐉𝐄 𝐁𝐎𝐓,
                    }, {
                        quoted: m
                    }
                );
...
m.reply (`⭓𝐏𝐨𝐧𝐠\n *${dreadedspeed.toFixed(4)}* 𝐌𝐬`);
 ...
 case "runtime": { 
                 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/a91218a98b91ec37fac81.mp4' }, caption: `𝐓𝐎𝐍𝐉𝐄_𝐀𝐈 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛 ${runtime(process.uptime())}`,gifPlayback: true }, { quoted: m }); 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/5e29ca126d7a46aa3aef4.mp4' }, caption: `𝐇𝐞𝐥𝐥𝐨 *${m.pushName}*, 𝐓𝐎𝐍𝐉𝐄 𝐀𝐈 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐚𝐥𝐢𝐯𝐞 𝐬𝐢𝐧𝐜𝐞 *${runtime(process.uptime())}*,\n\n➥𝐓𝐲𝐩𝐞 ${prefix}𝐦𝐞𝐧𝐮 𝐭𝐨 𝐚𝐜𝐜𝐞𝐬𝐬 𝐦𝐲 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐥𝐢𝐬𝐭.\n➥𝐓𝐲𝐩𝐞 ${prefix}𝐫𝐞𝐩𝐨 𝐭𝐨 𝐠𝐞𝐭 𝐦𝐲 𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐨𝐝𝐞.\n➥𝐓𝐲𝐩𝐞 ${prefix}𝐨𝐰𝐧𝐞𝐫 𝐭𝐨 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 𝐦𝐲 𝐜𝐫𝐞𝐚𝐭𝐨𝐫.\n\n✘𝐄𝐧𝐣𝐨𝐲 𝐚𝐧𝐝 𝐇𝐚𝐯𝐞 𝐟𝐮𝐧 𝐰𝐢𝐭𝐡 𝐭𝐡𝐞 𝐛𝐨𝐭.\n✘𝐌𝐚𝐝𝐞 [𝐂𝐥𝐨𝐧𝐞𝐝] 𝐛𝐲 𝐢𝐭'𝐬 𝐓𝐨𝐧𝐣𝐞 ࣩࣧࣧ`,gifPlayback: true }, { quoted: m });
 }
break;
case 'apk': {
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 𝐓𝐎𝐍𝐉𝐄 𝐀𝐈🗿*`}, { quoted: m }) 
...
case "movie": 
 ...
 break;
      ...
      case "𝐢𝐭'𝐬 𝐓𝐨𝐧𝐣𝐞": case "owner": case "𝐢𝐭'𝐬 𝐓𝐨𝐧𝐣𝐞": 
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/6b0e00c0fbd44e475b5a0.mp4' }, caption: `𝐇𝐞𝐫𝐞 𝐢𝐬 𝐦𝐲 𝐇𝐚𝐧𝐝𝐬𝐨𝐦𝐞 𝐎𝐰𝐧𝐞𝐫, +254113069954 (>ᴗ•)🤭` }, {quoted: m}); 
 ...
 break;
        ...
        case "gpt": case "g": 
            ...
            if (!text) return reply("Hello am 𝐓𝐎𝐍𝐉𝐄 an Ai developed by 𝐢𝐭'𝐬 𝐓𝐨𝐧𝐣𝐞, how can I help you today?");
...
async function handleGPTMessage(text, m) {
  if (!text) return m.reply("Hello am 𝐓𝐎𝐍𝐉𝐄 an Ai developed by 𝐢𝐭'𝐬 𝐓𝐨𝐧𝐣𝐞, how can I help you today?");
